...
**If you do not, the built in profit tracking will not be able to detect the new deposit, resulting in poor graphical representation. Resetting ensures that a new baseline is established.**
...
4. Ensure all account privileges are enabled, importantly read/write capabilities for orders, wallets.
...
5. For added safety, you will want to enable IP Restrictions. This will ensure your API key can only be accessed using your IP address.

  6. Use the drop down and enable IP Restriction, confirming using your 2fa and/or the link sent to your email.

  7. Copy paste the IP address provided into the field and click save, again confirming using your 2fa and/or the link sent to your email.
